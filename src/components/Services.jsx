export default function Services() {
    ...
    return (
        <div id="services" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Dedicated Frontend Developer from Kathmandu, focused on mastering React and modern web architecture. I bridge the gap between early-career passion and professional-grade execution, building scalable, high-quality interfaces with a deep commitment to user-centric design and clean code.</p>
