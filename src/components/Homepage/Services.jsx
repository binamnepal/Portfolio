...
export default function Services() {
    const services = [
        {
            ...
            description:
                "Creating visually stunning, user-centric designs that prioritize usability and brand identity.",
            link: "#",
        },
        {
            name: "UI/UX Design",
            ...
            description:
                "Focusing on the user journey and interaction patterns to solve complex problems simply.",
            link: "#",
        },
    ];
    ...
    return (
        ...
        >
            ...
            >
                Based in Kathmandu, I build fast, responsive, and visually appealing interfaces that deliver great user experiences.
            </motion.p>
            ...
            >
                {services.map((service, index) => (
                    ...
                    >
                        <img src={service.icon} className="w-10 dark:invert" />
                        ...
                        <a
                            href={service.link}
                            className="flex items-center gap-2 text-sm mt-5 font-medium group text-gray-700 dark:text-white"
                        >
                            Read more
                            <img
